...
public class AccountService 
{
	...
	//Account creation
	public ArrayList<Customer> createAccount(ArrayList<Customer> customers) 
	{
		...
		if (findCustomerId == null) {
			System.out.println("Customer Id is not available!! Please create a new Account");
	...
	//Search customer id of an existing customer
	public String checkCustomer(String customerIdEnter, ArrayList<Customer> customers) 
	{
	...
	public ArrayList<Customer> createNewCustomerAccount(ArrayList<Customer> customers) { 
